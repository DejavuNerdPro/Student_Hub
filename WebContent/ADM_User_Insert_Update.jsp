...
$(document).ready(function(){
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">User Managing</h2>
                                </div>
                            </div>
                        </div>
  ...
  <div class="form-outline mb-4">
    <input type="text" id="form1Example2" class="form-control" placeholder="Enter User Name" name="username" required/>
  </div>

  <div class="form-outline mb-4">
    <input type="email" id="form1Example2" class="form-control" placeholder="Enter Email" name="email" required/>
  </div>

  <div class="form-outline mb-4">
    <input type="text" id="form1Example2" class="form-control" placeholder="Enter Phone Number" name="phone" required/>
  </div>

  <div class="form-outline mb-4">
    <input type="text" id="form1Example2" class="form-control" placeholder="Enter Address" name="address" required/>
  </div>

  <!-- Password input -->
  <div class="form-outline mb-4">
  <div class="row"><div class="col-md-6">
  <div style="white-space:nowrap;"><input type="checkbox" name="gender" required/> Male</div>
  </div>
  <div class="col-md-6">
