            ...
            <section class="statistic" style="margin-top:20px;">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                            <div class="row">
                                <div class="col">
                                    <div class="row w-100"><div class="col" style="float:left;"><h2 class="title-1 m-b-25">Managing Timetables</h2></div><div class="col" style="position:absolute;left:80%;top:2%;margin-left:50px;"><Button class="btn btn-primary btn-sm"><i class="fa fa-plus" style="color:white;"></i>&nbsp;ADD</Button></div></div>
                                        ...
                                        <table class="table table-borderless table-hover" width="100%" height="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Male</td>
                                                    <td class="text-right"><a href="#" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i></a><a href="#" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                                <tr>
